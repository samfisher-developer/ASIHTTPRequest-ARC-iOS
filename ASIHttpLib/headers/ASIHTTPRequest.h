...
typedef enum _ASIHTTPRequestType {
    ASIHTTPDefaultRequest,
	ASIHTTPLoginRequest,
	ASIHTTPProfileRequest,
	ASIHTTPPhotosRequest,
	ASIHTTPPlacesRequest,
	ASIHTTPCheckINRequest,
	ASIHTTPInfoRequest,
	ASIHTTPLinkPostRequest,
	ASIHTTPWallPostRequest,
	ASIHTTPProfilePicRequest,
	ASIHTTPDownloadRequest
} ASIHTTPRequestType;
...
@interface ASIHTTPRequest : NSOperation <NSCopying> {
	...
	ASIHTTPRequestType requestType;
...
@property(readwrite)ASIHTTPRequestType requestType;
